<template>
  	<div class="banner clearfix">
		<ul class="clearfix" style="transform:translateX(-16.66%);">
			...
			<li>
				<a href="#">
					<img src="./../../assets/toutiaoNew/b4.jpg" alt="">
				</a>
			</li>

			<li>
				<a href="#">
					<img src="./../../assets/toutiaoNew/b1.jpg" alt="">
				</a>
			</li>

			<li>
				<a href="#">
					<img src="./../../assets/toutiaoNew/b2.jpg" alt="">
				</a>
			</li>

			<li>
				<a href="#">
					<img src="./../../assets/toutiaoNew/b3.jpg" alt="">
				</a>
			</li>
